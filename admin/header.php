                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active">
                                <a href="index.php">
                                    <i class="fa fa-home"></i> &nbsp; <span>DASHBOARD</span> <span
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i
                                        class="fa fa-folder"></i> &nbsp; MASTER DATA <span class="caret"></span></a>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <i
                                        class="fa fa-users"></i> &nbsp; PENGGUNA <span class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="user.php">
              ...
              ?>
                            <li class="dropdown notifications-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="header text-center">Ada <b><?php echo $jumlah_limit; ?></b> produk yang
                                        hampir habis.</li>
                                    <li>
                                        <ul class="menu">
                                            <?php 
                      while($l = mysqli_fetch_array($limit)){ ?>
                                            <li>
                                                <a href="produk.php">
                                                    ...
                                                    <b><?php echo $l['produk_nama'] ?></b> <span
                                                        class="pull-right">tersisa
                                                        <b><?php echo $l['produk_stok']; ?></b></span>
                                                </a>
                                            </li>
                                            <?php } ?>
                                        </ul>
