          ...
          <form action="produk_act.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-lg-6">
                ...
                <input type="number" class="form-control" name="harga_modal" required="required" placeholder="Harga Modal .. (Wajib)">
              </div>

              <div class="form-group col-lg-6">
                <label>Harga Jual</label>
                <input type="number" class="form-control" name="harga_jual" required="required" placeholder="Harga Jual .. (Wajib)">
              </div>
            </div>
