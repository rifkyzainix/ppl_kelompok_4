            ...
            <section class="col-lg-6 col-lg-offset-3">
                <div class="box box-info">
                    ...
                    <div class="box-header">
                        ...
                        <a href="kasir.php" class="btn btn-primary btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp;
                            Kembali</a>
                    </div>
                    <div class="box-body">
                ...
                ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama"
                                    value="<?php echo $d['kasir_nama'] ?>" required="required">
                                <input type="hidden" class="form-control" name="id" value="<?php echo $d['kasir_id'] ?>"
                                    required="required">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username"
                                    value="<?php echo $d['kasir_username'] ?>" required="required">
                            </div>
