...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="menu-kotak" style="margin-top: 25px;margin-bottom: 15px">

            <div class="navbar-header">

                <button type="button" class="navbar-toggle collapsed btn-primary" data-toggle="collapse"
                    data-target="#navbar-collapse2">
                    <i class="fa fa-bars"></i> NAVIGASI
                </button>
            ...
            <div class="row">
                <div class="collapse navbar-collapse" id="navbar-collapse2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 col-md-1 col-xs-3">
                            <div class="bg-primary text-center" style="padding: 13px 5px;">
                                <a href="index.php" style="color: white">
                                    <h1 style="padding: 0;margin: 0"><i class="fa fa-home"></i></h1>
                        ...
                        <div class="col-lg-1 col-md-1 col-xs-3">
                            <div class="bg-primary text-center" style="padding: 13px 5px;">
                                <a href="kategori.php" style="color: white">
                                    <h1 style="padding: 0;margin: 0"><i class="fa fa-folder"></i></h1>
                                    <h5 style="padding: 0;margin: 0">Kategori</h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 col-md-1 col-xs-3">
                            <div class="bg-primary text-center" style="padding: 13px 5px;">
                                <a href="produk.php" style="color: white">
                                    <h1 style="padding: 0;margin: 0"><i class="fa fa-folder"></i></h1>
                                    <h5 style="padding: 0;margin: 0">Produk</h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 col-md-1 col-xs-3">
                            <div class="bg-primary text-center" style="padding: 13px 5px;">
                                <a href="kasir.php" style="color: white">
                                    <h1 style="padding: 0;margin: 0"><i class="fa fa-user"></i></h1>
                                    <h5 style="padding: 0;margin: 0">Kasir</h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 col-md-1 col-xs-3">
                            <div class="bg-primary text-center" style="padding: 13px 5px;">
                                <a href="penjualan.php" style="color: white">
                                    <h1 style="padding: 0;margin: 0"><i class="fa fa-list"></i></h1>
                                    <h5 style="padding: 0;margin: 0">Penjualan</h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 col-md-1 col-xs-3">
                            <div class="bg-primary text-center" style="padding: 13px 5px;">
                                <a href="laporan.php" style="color: white">
                                    <h1 style="padding: 0;margin: 0"><i class="fa fa-file"></i></h1>
                                    <h5 style="padding: 0;margin: 0">Laporan</h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 col-md-1 col-xs-3">
                            <div class="bg-primary text-center" style="padding: 13px 5px;">
                                <a href="gantipassword.php" style="color: white">
                                    <h1 style="padding: 0;margin: 0"><i class="fa fa-unlock"></i></h1>
                                    <h5 style="padding: 0;margin: 0">Password</h5>
                                </a>
                            </div>
                        </div>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            ?>
                        <h4 style="font-weight: bolder"><?php echo "Rp. ".number_format($p['total_invoice'])." ,-" ?>
                        </h4>
