  ...
  <footer class="main-footer">
      ...
      <strong>Copyright &copy; <?php echo date('Y'); ?></strong> - Sistem Informasi Penjualan Kasir - POS (Point Of
      Sales)
  </footer>
    ...
    $("body").on("click", "#tombol-tambahkan", function() {
        ...
        if (id.length == 0) {
            ...
            var table_pembelian = "<tr id='tr_" + id + "'>" +
                "<td> <input type='hidden' name='transaksi_produk[]' value='" + id +
                ...
                "<td align='center'> <span class='btn btn-sm btn-danger tombol-hapus-penjualan' total='" +
                total + "' jumlah='" + jumlah + "' harga='" + harga + "' id='" + id +
