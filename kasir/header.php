                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i
                                        class="fa fa-shopping-cart"></i> &nbsp; TRANSAKSI PENJUALAN <span
                                        class="caret"></span></a>
                            ...
                            <li class="dropdown notifications-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="label label-danger">
                                        <?php echo $jumlah_limit; ?>
                                    </span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="header text-center">Ada <b>
                                            <?php echo $jumlah_limit; ?>
                                        </b> produk yang
                                        hampir habis.</li>
                                    <li>
                      ...
                      while ($l = mysqli_fetch_array($limit)) { ?>
                                            <li>
                                                <a href="produk.php">
                                                    ...
                                                    <b>
                                                        <?php echo $l['produk_nama'] ?>
                                                    </b> <span class="pull-right">tersisa
                                                        <b>
                                                            <?php echo $l['produk_stok']; ?>
                                                        </b></span>
                                                </a>
                                            </li>
                                            <?php } ?>
